...
- 예외 단 1개: prod incident 긴급 복구는 `workflows/hotfix.md` 절차로 진행 후 24h 내 이슈 사후 작성
...
- branch: `git/branch.md`, `git/worktree.md`
...
- 분기 절차: `workflows/{migration,add-context,add-python-pipeline,hotfix,poc,release,cicd}`
